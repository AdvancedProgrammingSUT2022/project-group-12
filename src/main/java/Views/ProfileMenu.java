...
public class ProfileMenu extends Menu {
    protected ProfileMenuController controller = new ProfileMenuController();
    ...
    protected void handleCommand(Command command) {
        ...
        if ((matcher = InputRegex.getMatcher(input, InputRegex.CHANGE_NICKNAME)) != null) {
            ...
            System.out.println(this.controller.changePass(matcher));
            ...
            System.out.println(this.controller.enterMenu(matcher));
