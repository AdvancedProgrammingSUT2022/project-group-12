...
public enum DatabaseQueryType {
    ...
    GET_CIV_UNITS, GET_ALL_UNITS_ENUMS, GET_ALL_BUILDING_ENUMS, GET_CURRENTCIV_HAPPINESS, GET_CURRENTCIV_INWARWITH, GET_CIV_GOLD_BY_NAME, GET_CURRENTCIV_NOTIFICATIONS;
}
