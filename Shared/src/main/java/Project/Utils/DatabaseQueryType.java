...
public enum DatabaseQueryType {
    ...
    GET_IS_USERNAME_ONLINE, GET_USER_CHATS_NAMES, SEND_CHAT_TO_CREATE,  GET_CHAT_BY_NAME, UPDATE_CHAT,
    GET_PUBLIC_OPENGAME_ITEMS_CHOOSE,
    GET_ORIGINAL_TILE_GRID,
   GET_CURRENT_YEAR, GET_PUBLIC_CHAT, SEND_PUBLIC_CHAT_UPDATE,
    CREATE_GAME,
    GET_OPENGAME_BY_TOKEN,
    LEAVE_ROOM,
    JOIN_ROOM,
    GET_RUNNING_GAME_ITEMS_CHOOSE,
    START_GAME,
    GET_RUNNING_GAME_ITEMS_OF_USER, SEND_LOBBY_CHAT_UPDATE;
}
