...
public class DatabaseQuerier {
    ...
    public static ArrayList<User> getAllUsers() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_ALL_USERS);
    ...
    public static ArrayList<String> getAllUsernames() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_ALL_USERNAMES);
    ...
    public static User getUser(String username) {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_USER_BY_USERNAME, username);
    ...
    public static ArrayList<Location> getCivTilesLocations() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CIV_TILES_LOCATIONS);
    ...
    public static ArrayList<Unit> getCurrentCivilizationUnits() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CIV_UNITS);
        return new Gson().fromJson(json, new TypeToken<ArrayList<Unit>>() {
        }.getType());
    }

    public static ArrayList<Resource> getCivResources() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CIV_RESOURCES);
    ...
    public static HashMap<String, Integer> getTileGridSize() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_TILEGRID_SIZE);
    ...
    public static ArrayList<UnitEnum> getUnitEnums() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_ALL_UNITS_ENUMS);
        return new Gson().fromJson(json, new TypeToken<ArrayList<UnitEnum>>() {
        }.getType());
    }

    public static ArrayList<BuildingEnum> getBuildingEnums() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_ALL_BUILDING_ENUMS);
        return new Gson().fromJson(json, new TypeToken<ArrayList<BuildingEnum>>() {
        }.getType());
    }

    public static int getHappinessOfCurrentCiv() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_HAPPINESS);
        return new Gson().fromJson(json, new TypeToken<Integer>() {
        }.getType());
    }

    public static int getFoodOfCurrentCiv() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_FOOD);
        return new Gson().fromJson(json, new TypeToken<Integer>() {
        }.getType());
    }

    public static int getGoldOfCurrentCiv() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_GOLD);
        return new Gson().fromJson(json, new TypeToken<Integer>() {
        }.getType());
    }

    public static int getScienceOfCurrentCiv() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_SCIENCE);
        return new Gson().fromJson(json, new TypeToken<Integer>() {
        }.getType());
    }
    ...
    public static ArrayList<String> getCurrentCivInWarWith() {
        ...
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_INWARWITH);
        return new Gson().fromJson(json, new TypeToken<ArrayList<String>>() {
        }.getType());
    }

    public static List<String> getNeighborsCivsName() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_NEIGHBORS_CURRENTCIV_NAMES);
        return new Gson().fromJson(json, new TypeToken<List<String>>() {
        }.getType());
    }

    public static int getGoldCivilizationByName(String name) {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CIV_GOLD_BY_NAME, name);
        return new Gson().fromJson(json, new TypeToken<Integer>() {
        }.getType());
    }

    public static ArrayList<Resource> getCivResourcesByName(String name) {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CIV_RESOURCES_BY_NAME, name);
        TypeToken<ArrayList<Resource>> typeToken = new TypeToken<>() {
        };
        return new Gson().fromJson(json, typeToken.getType());
    }
    ...
    public static ArrayList<Notification> getCurrentCivNotifications() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_NOTIFICATIONS);
    ...
    public static ArrayList<Location> getCurrentCivUnitsLocation() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_UNITS_LOCATIONS);
        TypeToken<ArrayList<Location>> typeToken = new TypeToken<>() {
        };
        return new Gson().fromJson(json, typeToken.getType());
    }
    ...
    public static ArrayList<String> getCurrentCivCitiesNames() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_CITIES_NAMES);
        TypeToken<ArrayList<String>> typeToken = new TypeToken<>() {
        };
        return new Gson().fromJson(json, typeToken.getType());
    }
    ...
    public static ArrayList<String> getCurrentCivUnitsNames() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_UNITS_NAMES);
        TypeToken<ArrayList<String>> typeToken = new TypeToken<>() {
        };
        return new Gson().fromJson(json, typeToken.getType());
    }
    ...
    public static Location getCurrentCivLocationByName(String cityName) {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_CITIES_LOCATION_BY_NAME, cityName);
    ...
    public static Unit getSelectedUnit() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_SELECTED_UNIT);
//        System.out.println(json);
    ...
    public static Tile getTileByLocation(String row, String col) {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_TILE_BY_LOCATION, row, col);
//        System.out.println(json);
        GsonBuilder gsonBuilder = new GsonBuilder();
        gsonBuilder.registerTypeAdapter(Unit.class, new MyJsonDeserializer<>());
    ...
    public static City getSelectedCity() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_SELECTED_CITY);
        return new Gson().fromJson(json, City.class);
    }

    public static ArrayList<TechnologyEnum> getTechnologies() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_TECHNOLOGIES);
        return new Gson().fromJson(json, new TypeToken<ArrayList<TechnologyEnum>>() {
        }.getType());
    }

    public static String getCurrentCivName() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_NAME);
        return new Gson().fromJson(json, String.class);
    }

    public static TechnologyEnum getResearchingTechnology() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_RESEARCHING_TECHNOLOGY);
    ...
    public static HashMap<TechnologyEnum, Integer> getResearchingTechnologies() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_RESEARCHING_TECHNOLOGIES);
        return new Gson().fromJson(json, new TypeToken<HashMap<TechnologyEnum, Integer>>() {
        }.getType());
    }

    public static TileGrid getTileGrid() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_TILE_GRID);
//        System.out.println(json);
        GsonBuilder gsonBuilder = new GsonBuilder();
        gsonBuilder.registerTypeAdapter(Unit.class, new MyJsonDeserializer<>());
        gsonBuilder.registerTypeAdapter(Notifier.class, new MyJsonDeserializer<>());
    ...
    public static List<String> getCurrentCivInPeaceWith() {
        String json = RequestHandler.getInstance().databaseQuery(RequestType.GET_CURRENTCIV_INPEACEWITH);
        return new Gson().fromJson(json, new TypeToken<ArrayList<String>>() {
        }.getType());
    }
}
