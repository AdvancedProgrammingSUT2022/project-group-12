...
public class ServerMain {
    ...
    public static void main(String[] args) throws IOException {
        Database.getInstance().logoutUsers();
        createDataBaseSerialization();
...
//            System.out.println("server is running (clients can start game) ...");
    ...
    private static void createDataBaseSerialization() {
        new DataBaseSerialization(new XStream(new StaxDriver()),"temp.txt");
    }
}
